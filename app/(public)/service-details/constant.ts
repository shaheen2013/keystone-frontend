 ...
 export const ourProcessData ={
  ...
  steps: [
    ...
    },
    {
      ...
      title: "Ongoing Support",
      description:
        "We provide continuous resources and training so parents feel empowered to advocate for their child in the long run.",
    },
  ],
 }

export const exploreOtherServicesData = {
