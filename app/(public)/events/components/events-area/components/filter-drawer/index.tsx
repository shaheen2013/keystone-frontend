...
const FilterDrawer = (
  {selectedServices, setSelectedServices,selectedEventTypes, setSelectedEventTypes, handleResetFilter}:
  { selectedServices: string[], setSelectedServices: React.Dispatch<React.SetStateAction<string[]>>,
    selectedEventTypes: string[], setSelectedEventTypes: React.Dispatch<React.SetStateAction<string[]>>, 
