...
const Services = ({ selectedServices, setSelectedServices }: { selectedServices: string[], setSelectedServices: React.Dispatch<React.SetStateAction<string[]>> }) => {
     // services 

  const {data: servicesResponse, isLoading: isServicesLoading, isFetching: isServicesFetching}: any = useGetServicesQuery({});
