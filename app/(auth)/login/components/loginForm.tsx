...
export default function LoginForm() {
  ...
  return (
    <div className="flex flex-col justify-between items-center h-screen px-4 lg:pt-5 pt-5 dev">
      <div className=" flex justify-center items-center dev">
      ...
      <p className="text-gray-9 lg:text-base text-xs font-medium py-6 lg:mt-0 mt-8 dev">
